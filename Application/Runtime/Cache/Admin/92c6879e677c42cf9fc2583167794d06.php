...
<script type="text/javascript" src="/cms/Public/js/admin_login.js"></script>
</head>
<body>

<form id="adminLogin" name="login" method="post" action="">
	<fieldset>
		...
		<label><img src="<?php echo U('Login/v_code');?>" onclick="javascript:this.src='<?php echo U("Login/v_code");?>?tm='+Math.random();" /></label>
